...
{
    public class RBAC_RESOURCE_FIELDS : TableFields
    {
        ...
        public const string FIELD_RESOURCE_NAME = "RESOURCE_NAME";    //RESOURCE_GUID
        ...
        public const string FIELD_RESOURCE_CODE = "RESOURCE_CODE";
        #endregion

        #region table name define
        public const string DATABASE_TABLE_NAME = "RBAC_RESOURCE";       //TABLE NAME
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  ...
                                                                  {FIELD_RESOURCE_NAME , new FieldProperties() },  //RESOURCE_GUID
                                                                  ...
                                                                  {FIELD_RESOURCE_CODE,new FieldProperties()}
                                                                };
        #endregion
    }
}
