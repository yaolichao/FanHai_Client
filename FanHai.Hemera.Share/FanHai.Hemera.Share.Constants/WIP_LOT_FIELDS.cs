...
namespace FanHai.Hemera.Share.Constants
{
    ...
    /// </summary>
    public class WIP_LOT_FIELDS : TableFields
    {
        #region
        /// <summary>
        /// 交易记录主键值
        ...
        /// 数据库表名称。
        /// </summary>
        public const string DATABASE_TABLE_NAME = "WIP_LOT";                                //TABLE NAME
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  {FIELD_TRANSACTION_KEY,new FieldProperties()},                //交易主键值
                                                                  ...
                                                                  {FIELD_PRO_LEVEL,new FieldProperties()},                       //产品等级
                                                              };
