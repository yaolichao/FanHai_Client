...
{
    public class RBAC_ROLE_OWN_OPERATION_FIELDS:TableFields
    {
        ...
        public const string DATABASE_TABLE_NAME = "RBAC_ROLE_OWN_OPERATION";       //TABLE NAME
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  ...
                                                                  {FIELD_OPERATION_NAME, new FieldProperties() },  //Operation Name
