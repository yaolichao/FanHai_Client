...
{
    public class RBAC_ROLE_OWN_STORE_FIELDS : TableFields
    {
        ...
        public const string DATABASE_TABLE_NAME = "RBAC_ROLE_OWN_STORE";       //TABLE NAME
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  ...
                                                                  {FIELD_STORE_NAME , new FieldProperties() },  //Line Name
