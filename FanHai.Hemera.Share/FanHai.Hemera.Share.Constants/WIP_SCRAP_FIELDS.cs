...
{
    /// <summary>
    /// 表示电池片报废或组件报废的数据表字段实体类。
    /// </summary>
    public class WIP_SCRAP_FIELDS:TableFields
    {
        /// <summary>
        /// 操作主键。
        /// </summary>
        ...
        /// 报废数量。
        /// </summary>
        public const string FIELD_SCRAP_QUANTITY = "SCRAP_QUANTITY";
        /// <summary>
        /// 工艺流程组主键。
        /// </summary>
        ...
        /// 数据库表名称。
        /// </summary>
        public const string DATABASE_TABLE_NAME = "WIP_SCRAP";
        /// <summary>
        /// 数据库表名称。
        /// </summary>
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  ...
                                                                  {FIELD_SCRAP_QUANTITY,new FieldProperties(typeof(double),true,0) },
