...
namespace FanHai.Hemera.Share.Constants
{
    ...
    /// 表示工步参数的数据库表及其字段的实体类。
    /// </summary>
    public class POR_ROUTE_STEP_PARAM_FIELDS : TableFields
    {
        /// <summary>
        /// 工步参数主键。
        /// </summary>
        public const string FIELD_ROUTE_STEP_PARAM_KEY = "ROUTE_STEP_PARAM_KEY";
        /// <summary>
        /// 工步主键。
        /// </summary>
        ...
        /// <summary>
        /// 验证规则  0：不验证 1：前缀匹配工单设定的内容2：后缀匹配工单设定的内容 3：内容包含工单设定的数据 4：完全匹配工单设定的数据 5：工单Bom料号匹配。
        /// </summary>
        ...
        /// 工序参数表名称。
        /// </summary>
        public const string DATABASE_TABLE_NAME = "POR_ROUTE_STEP_PARAM";
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  {FIELD_ROUTE_STEP_PARAM_KEY , new FieldProperties() },
