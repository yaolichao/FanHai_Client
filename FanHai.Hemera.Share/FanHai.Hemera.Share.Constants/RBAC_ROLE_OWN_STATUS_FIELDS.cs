...
{
    public class RBAC_ROLE_OWN_STATUS_FIELDS : TableFields
    {
        ...
        public const string DATABASE_TABLE_NAME = "RBAC_ROLE_OWN_STATUS";       //TABLE NAME
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  ...
                                                                  {FIELD_EQUIPMENT_STATE_NAME , new FieldProperties() },  //Line Name
