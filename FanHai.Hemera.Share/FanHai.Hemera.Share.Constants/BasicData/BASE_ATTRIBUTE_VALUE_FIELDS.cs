...
namespace FanHai.Hemera.Share.Constants
{
    ...
    public class BASE_ATTRIBUTE_VALUE_FIELDS : TableFields
    {
        #region columns define
        public const string FIELD_OBJECT_KEY = "OBJECT_KEY";
        public const string FIELD_OBJECT_TYPE = "OBJECT_TYPE";  
        ...
        public const string DATABASE_TABLE_NAME = "BASE_ATTRIBUTE_VALUE";       //TABLE NAME
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  {FIELD_OBJECT_KEY , new FieldProperties() },
                                                                  {FIELD_OBJECT_TYPE, new FieldProperties() },
