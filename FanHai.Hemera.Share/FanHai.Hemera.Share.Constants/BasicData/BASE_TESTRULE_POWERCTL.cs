...
{
    public class BASE_TESTRULE_POWERCTL : TableFields
    {
        #region fields
        /// <summary>
        /// 主键值
        /// </summary>
        public const string FIELDS_POWER_CONTROL_KEY = "POWER_CONTROL_KEY";
        /// <summary>
        /// 主键值（测试规则主表ID）
        /// </summary>
        ...
        /// 控制对象
        /// </summary>
        public const string FIELDS_POWERCTL_OBJ = "POWERCTL_OBJ";
        /// <summary>
        /// 运算符-运算类型
        /// </summary>
        public const string FIELDS_POWERCTL_TYPE = "POWERCTL_TYPE";
        /// <summary>
        /// 值
        /// </summary>
        public const string FIELDS_POWERCTL_VALUE = "POWERCTL_VALUE"; 
        ...
        public const string DATABASE_TABLE_NAME = "BASE_TESTRULE_POWERCTL";
        public const string DATABASE_TABLE_FORUPDATE = "BASE_TESTRULE_POWERCTL_UPDATE";
        public const string DATABASE_TABLE_FORINSERT = "BASE_TESTRULE_POWERCTL_INSERT";
        #endregion
        ...
        private static Dictionary<string, FieldProperties> _fields = new Dictionary<string, FieldProperties>
                                                              {
                                                                  {FIELDS_POWER_CONTROL_KEY, new FieldProperties() },
                                                                  ...
                                                                  {FIELDS_POWERCTL_OBJ, new FieldProperties() },                                           
                                                                  {FIELDS_POWERCTL_TYPE, new FieldProperties() },
                                                                  {FIELDS_POWERCTL_VALUE, new FieldProperties() },
